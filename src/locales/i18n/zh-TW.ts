...
export const ZH_TW: SystemLangMap = {
  ...
  'PC.Pages.Setting.themeLoadFailed': '主題配置載入失敗',
  ...
  'PC.Pages.AgentArrangeConfig.addPlugin': '新增外掛',
  ...
  'PC.Pages.SystemConfigSandboxConfig.globalConfig': '全域性配置',
  ...
  'PC.Pages.Home.linkConfigError': '連結地址配置錯誤',
  ...
  'PC.Components.Created.tabPlugin': '外掛',
  ...
  'PC.Pages.SystemThemeConfig.saveConfig': '儲存配置',
  'PC.Pages.SystemThemeConfig.resetDefault': '重置預設',
  'PC.Pages.SystemThemeConfig.saveSuccess': '主題配置儲存成功',
  'PC.Pages.SystemThemeConfig.resetPreview': '已重置為預設配置（預覽效果）',
  ...
  'PC.Pages.SystemContentPlugin.searchName': '請輸入外掛名稱',
  ...
  'PC.Pages.SystemContentPlugin.pageTitle': '外掛管理',
  ...
  'PC.Pages.AppDevMessageAttachment.dataSourcePlugin': '外掛',
  ...
  'PC.Pages.AppDevMentionSelector.workflowPluginEtc': '工作流、外掛等',
  ...
  'PC.Pages.AppDevMentionSelector.dataSourceTypePlugin': '外掛',
  ...
  'PC.Pages.SystemDashboard.resourcePlugin': '外掛',
  ...
  'PC.Pages.SystemRunningLogTable.targetTypePlugin': '外掛',
  ...
  'PC.Pages.SystemRunningLogNodeDetails.targetTypePlugin': '外掛',
  ...
  'PC.Pages.SystemMenuPermissionModal.titleWithName': '選單許可權配置-{0}',
  ...
  'PC.Pages.SpaceLibrary.Index.pageTitle': '元件庫',
  ...
  'PC.Pages.SpaceLibrary.Index.pluginCopySuccess': '外掛複製成功',
  'PC.Pages.SpaceLibrary.Index.pluginDeleteSuccess': '外掛刪除成功',
  ...
  'PC.Pages.SpaceLibrary.CreateModel.apiConfig': '介面配置',
  ...
  'PC.Pages.EditAgent.PreviewAndDebug.PreviewAndDebugHeader.openAgentDesktop':
    '開啟智慧體電腦',
  'PC.Pages.EditAgent.NodeDetails.typePlugin': '外掛',
  ...
  'PC.Pages.SpaceLibraryLog.NodeDetails.typePlugin': '外掛',
  ...
  'PC.Pages.Square.PluginDetail.pluginDescription': '外掛描述',
  ...
  'PC.Pages.SpaceLog.NodeDetails.typePlugin': '外掛',
  ...
  'PC.Pages.PublishAudit.typePlugin': '外掛',
  ...
  'PC.Pages.SpacePluginTool.PluginHeader.configSavedAt': '配置儲存於{0}',
  ...
  'PC.Layouts.DynamicMenusLayout.SquareSection.plugin': '外掛',
  ...
  'PC.Pages.MorePage.ApiKeyPermission.permissionSaved': '許可權配置儲存成功',
  ...
  'PC.Pages.EcosystemTemplate.unnamedTemplate': '未命名外掛',
  ...
  'PC.Pages.EcosystemPlugin.title': '外掛',
  'PC.Pages.EcosystemPlugin.unnamedPlugin': '未命名外掛',
  'PC.Pages.EcosystemPlugin.noDescription': '暫無描述',
  'PC.Pages.EcosystemPlugin.fetchListFailed': '獲取外掛列表失敗',
  ...
  'PC.Pages.EcosystemPlugin.fetchDetailFailed': '獲取外掛詳情失敗',
  'PC.Pages.EcosystemPlugin.pluginOffline': '外掛已下線',
  'PC.Pages.EcosystemPlugin.pluginWithdrawn': '外掛已撤銷釋出',
  'PC.Pages.EcosystemPlugin.searchPlaceholder': '搜尋外掛',
  ...
  'PC.Components.PluginCardDetail.pluginDescription': '外掛描述',
  'PC.Components.PluginCardDetail.detailedInfo': '詳細資訊',
  'PC.Components.PluginCardDetail.pluginName': '外掛名稱',
  ...
  'PC.Components.RecommendList.pagePathParamError': '頁面路徑引數配置錯誤',
  ...
  'PC.Components.MoveCopyComponent.plugin': '外掛',
  ...
  'PC.Components.Skill.configInputParams': '配置輸入引數',
  ...
  'PC.Components.EcosystemDetailDrawer.saveConfigAndEnable': '儲存配置並啟用',
  ...
  'PC.Components.CreateNewPlugin.pluginUpdated': '外掛更新成功',
  'PC.Components.CreateNewPlugin.createPlugin': '新建外掛',
  'PC.Components.CreateNewPlugin.updatePlugin': '更新外掛',
  'PC.Components.CreateNewPlugin.pluginName': '外掛名稱',
  ...
  'PC.Components.CreateNewPlugin.pluginDescription': '外掛描述',
  ...
  'PC.Components.CreatedItem.plugin': '外掛',
  ...
  'PC.Components.EcosystemDetailDrawer.plugin': '外掛',
  ...
  'PC.Constants.Mcp.typePlugin': '外掛',
  ...
  'PC.Components.AgentType.plugin': '外掛',
  ...
  'PC.Constants.Library.supportFuncCall': '支援普通函式呼叫',
  'PC.Constants.Library.supportStreamFuncCall': '支援流式函式呼叫',
  'PC.Constants.Library.textCompletion': '文字補全',
  'PC.Constants.Library.textEdit': '文字編輯',
  ...
  'PC.Constants.PageDev.pathParamsConfig': '路徑引數配置',
  ...
  'PC.Constants.Space.exportConfig': '匯出配置',
  ...
  'PC.Pages.DataPermissionTabPanel.noApiPermission': '暫無 API 許可權配置',
