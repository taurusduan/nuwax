...
export const ZH_CN: SystemLangMap = {
  ...
  'PC.Pages.SystemUserGroupFormModal.maxUserCountRequired': '请输入最大用户数',
  'PC.Pages.SystemUserGroupFormModal.maxValueTip': '最大值为2147483647',
  ...
  'PC.Constants.Library.audioProcess': '语音处理',
