...
const ControlPanel: React.FC<ControlPanelProps> = ({
  ...
  const zoomOptions = [
    {
      label: t('PC.Pages.AntvX6ControlPanel.zoomIn10Percent'),
      value: '+',
    },
    {
    ...
    {
      label: t('PC.Pages.AntvX6ControlPanel.zoom100Percent'),
      value: 1,
    },
    {
      label: t('PC.Pages.AntvX6ControlPanel.zoom150Percent'),
      value: 1.5,
    },
